...
let descriptions = {
    ...
    0x01: "Flags for use with motor auto-off, bit15=calibrated_accel_near_zero, bit3=motor_overcurrent",
    0x02: "Motor status flags, bit9=current_param0e_limit, bit2=motor_power, bit1=usually_1",
    0x03: "Follow Loop (or Bot-Controller) → Per-joint velocity target",
    0x04: "Gyro angular velocity only, from MCU2 to each axis via cmd00",
    0x05: "Filtered (FIR+IIR) motor current target",
    0x06: "Filtered (FIR+IIR) motor current measurement sum",
    0x07: "Input voltage, in 1/10th volt units",
    0x08: "unknown, related to current state of follow loop (integrated heading)",
    0x09: "Stabilizing control input from MCU2 to each axis via cmd00",
    0x0b: "Gain for velocity control feedback loop",
    0x0d: "Denominator for motor current limit",
    0x0e: "Numerator for motor current limit in param02 bit9",
    ...
    0x17: "Calibration for input voltage ADC2 ch2",
    ...
    0x55: "IMU value captured during initialization",
    0x56: "IMU value captured during initialization",
    0x57: "IMU value captured during initialization",
    0x58: "Gyro drift compensation has been completed at startup flag (t=2)",
